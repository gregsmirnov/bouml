...
class UmlBasePackage : public UmlItem {
  public:
    ...
    static UmlPackage * findCppNamespace(const QCString & n, const UmlBasePackage * p = 0);
#endif
    ...
    // (including 'p' itself), else 0
    static UmlPackage * findJavaPackage(const QCString & n, const UmlBasePackage * p = 0);
#endif
    ...
    // (including 'p' itself), else 0
    static UmlPackage * findPythonPackage(const QCString & n, const UmlBasePackage * p = 0);
#endif
    ...
    // (including 'p' itself), else 0
    static UmlPackage * findIdlModule(const QCString & n, const UmlBasePackage * p = 0);
#endif
