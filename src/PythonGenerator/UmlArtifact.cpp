...
QCString UmlArtifact::imports;

void UmlArtifact::generate_imports(QTextOStream & f, QCString & made) {
...
void UmlArtifact::generate() {
  if (! managed) {
    ...
    const QCString filedef = pythonSource();
...
const QCString & UmlArtifact::all_imports()
{
  return imports;
}
